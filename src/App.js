...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
     return notify("To generate password you must select atleast one checkbox", true)
    }
    if (passwordLength < 5 || passwordLength > 25) {
      return notify("The password length should be between 5-25 characters", true)
    }
    else {
      let characterList = ""
      if (includeNumbers) {
      ...
      return notify("Password is generated successfully", false)
    }
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            ...
            <input className="pw" defaultValue={passwordLength} onChange={(e) => setPasswordLength(e.target.value)} type="number" id="password-stregth" name="password-strength" max="25" min="5" />
          </div>
          <div className="form-group">
